...
struct SignUpView: View {
    ...
    var alert: Alert {
        Alert(title: Text("Verify your emaiil ID"), message: Text("Please, click the link in the verification email sent to you"), dismissButton: .default(Text("Dismiss")) {
        ...
        VStack {
            ...
            VStack(spacing: 10) {
                ...
                Toggle(isOn: $agreeCheck) {
                    Text("Agree to the Terms and Conditions").fontWeight(.thin)
                }.frame(minWidth: 0, maxWidth: .infinity, alignment: .topLeading)
                ...
                Button(action: {
                    if (self.agreeCheck) {
                        ...
                        self.errorText = "Please agree to the terms and conditions!"
                    }
                }, label: {
                    Text("Sign Up")
                })
